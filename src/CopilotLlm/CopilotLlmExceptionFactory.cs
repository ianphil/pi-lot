...
internal static class CopilotLlmExceptionFactory
{
    public static CopilotLlmException Create(int statusCode, string? body)
    {
        ...
        return statusCode switch
        {
            ...
            _ => new CopilotLlmException(error.Message, error.Code, statusCode, error.Type, error.Param),
        };
    }
